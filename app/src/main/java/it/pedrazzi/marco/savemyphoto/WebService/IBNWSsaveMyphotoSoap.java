...
public class IBNWSsaveMyphotoSoap
{
    ...
    public IBNWSsaveMyphotoSoap(){}

    public IBNWSsaveMyphotoSoap(String url)
    {
        this.url = url;
    }

    public IBNWSsaveMyphotoSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        IBNExtendedSoapSerializationEnvelope envelope= new IBNExtendedSoapSerializationEnvelope(IBNExtendedSoapSerializationEnvelope.VER11);
        return envelope;
    }
