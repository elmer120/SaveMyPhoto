...
public class RVKWSsaveMyPhotoSoap12
{
    ...
    public RVKWSsaveMyPhotoSoap12(){}

    public RVKWSsaveMyPhotoSoap12(String url)
    {
        this.url = url;
    }

    public RVKWSsaveMyPhotoSoap12(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        RVKExtendedSoapSerializationEnvelope envelope= new RVKExtendedSoapSerializationEnvelope(RVKExtendedSoapSerializationEnvelope.VER12);
        return envelope;
    }
