...
public class TSHWSsaveMyPhotoSoap
{
    ...
    public TSHWSsaveMyPhotoSoap(){}

    public TSHWSsaveMyPhotoSoap(String url)
    {
        this.url = url;
    }

    public TSHWSsaveMyPhotoSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        TSHExtendedSoapSerializationEnvelope envelope= new TSHExtendedSoapSerializationEnvelope(TSHExtendedSoapSerializationEnvelope.VER11);
        return envelope;
    }
