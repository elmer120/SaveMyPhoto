...
public class RRCWSsaveMyPhotoSoap
{
    ...
    public RRCWSsaveMyPhotoSoap(){}

    public RRCWSsaveMyPhotoSoap(String url)
    {
        this.url = url;
    }

    public RRCWSsaveMyPhotoSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        RRCExtendedSoapSerializationEnvelope envelope= new RRCExtendedSoapSerializationEnvelope(RRCExtendedSoapSerializationEnvelope.VER11);
        return envelope;
    }
