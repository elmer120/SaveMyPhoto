...
public class RRCWSsaveMyPhotoSoap12
{
    interface RRCIWcfMethod
    {
        RRCExtendedSoapSerializationEnvelope CreateSoapEnvelope() throws java.lang.Exception;

        java.lang.Object ProcessResult(RRCExtendedSoapSerializationEnvelope __envelope,java.lang.Object result) throws java.lang.Exception;
    }
    ...
    public RRCWSsaveMyPhotoSoap12(){}

    public RRCWSsaveMyPhotoSoap12(String url)
    {
        this.url = url;
    }

    public RRCWSsaveMyPhotoSoap12(String url,int timeOut)
    {
        this.url = url;
    ...
    protected RRCExtendedSoapSerializationEnvelope createEnvelope()
    {
        RRCExtendedSoapSerializationEnvelope envelope= new RRCExtendedSoapSerializationEnvelope(RRCExtendedSoapSerializationEnvelope.VER12);
        return envelope;
    }
    
    protected java.util.List sendRequest(String methodName,RRCExtendedSoapSerializationEnvelope envelope,org.ksoap2.transport.Transport transport  )throws java.lang.Exception
    {
        return transport.call(methodName, envelope, httpHeaders);
    }

    java.lang.Object getResult(java.lang.Class destObj,java.lang.Object source,String resultName,RRCExtendedSoapSerializationEnvelope __envelope) throws java.lang.Exception
    {
        if(source==null)
        {
            return null;
    ...
    {
        return (Boolean)execute(new RRCIWcfMethod()
        {
            @Override
            public RRCExtendedSoapSerializationEnvelope CreateSoapEnvelope(){
              RRCExtendedSoapSerializationEnvelope __envelope = createEnvelope();
            ...
            @Override
            public java.lang.Object ProcessResult(RRCExtendedSoapSerializationEnvelope __envelope,java.lang.Object __result)throws java.lang.Exception {
    ...
    {
        return (Integer)execute(new RRCIWcfMethod()
        {
            @Override
            public RRCExtendedSoapSerializationEnvelope CreateSoapEnvelope(){
              RRCExtendedSoapSerializationEnvelope __envelope = createEnvelope();
        ...
        return (Boolean)execute(new RRCIWcfMethod()
        {
            ...
            public RRCExtendedSoapSerializationEnvelope CreateSoapEnvelope(){
              RRCExtendedSoapSerializationEnvelope __envelope = createEnvelope();
                ...
                __info.type=PropertyInfo.STRING_CLASS;
                __info.setValue(dataAcquisizione!=null?RRCHelper.getDateTimeFormat().format(dataAcquisizione):SoapPrimitive.NullSkip);
                __soapReq.addProperty(__info);
                __info = new PropertyInfo();
                __info.namespace="http://it.pedrazzi.marco.savemyphoto/";
    ...
    public RRCArrayOfString CheckMediaOnServer(final String nomeUtente,final Integer idDispositivo ) throws java.lang.Exception
    {
        return (RRCArrayOfString)execute(new RRCIWcfMethod()
        {
            @Override
            public RRCExtendedSoapSerializationEnvelope CreateSoapEnvelope(){
              RRCExtendedSoapSerializationEnvelope __envelope = createEnvelope();
            ...
            @Override
            public java.lang.Object ProcessResult(RRCExtendedSoapSerializationEnvelope __envelope,java.lang.Object __result)throws java.lang.Exception {
                return (RRCArrayOfString)getResult(RRCArrayOfString.class,__result,"CheckMediaOnServerResult",__envelope);
            }
...
/*This feature is available in Premium account, Check http://EasyWsdl.com/Payment/PremiumAccountDetails to see all benefits of Premium account*/
    ...
    protected java.lang.Object execute(RRCIWcfMethod wcfMethod,String methodName) throws java.lang.Exception
    {
        org.ksoap2.transport.Transport __httpTransport=createTransport();
        __httpTransport.debug=enableLogging;
        RRCExtendedSoapSerializationEnvelope __envelope=wcfMethod.CreateSoapEnvelope();
        try
        {
    ...
    java.lang.Exception convertToException(org.ksoap2.SoapFault fault,RRCExtendedSoapSerializationEnvelope envelope)
    {
