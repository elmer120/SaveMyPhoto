...
public class VJPWSsaveMyPhotoSoap
{
    ...
    public VJPWSsaveMyPhotoSoap(){}

    public VJPWSsaveMyPhotoSoap(String url)
    {
        this.url = url;
    }

    public VJPWSsaveMyPhotoSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        VJPExtendedSoapSerializationEnvelope envelope= new VJPExtendedSoapSerializationEnvelope(VJPExtendedSoapSerializationEnvelope.VER11);
        return envelope;
    }
