...
// Version: 5.0.8.2
//
// Created by Quasar Development at 02/05/2017
//
//---------------------------------------------------
...
public class VJPWSsaveMyPhotoSoap12
{
    interface VJPIWcfMethod
    {
        VJPExtendedSoapSerializationEnvelope CreateSoapEnvelope() throws java.lang.Exception;

        java.lang.Object ProcessResult(VJPExtendedSoapSerializationEnvelope __envelope,java.lang.Object result) throws java.lang.Exception;
    }
    String url="http://savemyphoto.gear.host/WSsaveMyphoto.asmx";
    //String url="http://10.0.0.85:51262/WSsaveMyphoto.asmx";

    int timeOut=60000;
    public List< HeaderProperty> httpHeaders;
    public boolean enableLogging;

    public VJPWSsaveMyPhotoSoap12(){}

    public VJPWSsaveMyPhotoSoap12(String url)
    {
        this.url = url;
    }

    public VJPWSsaveMyPhotoSoap12(String url,int timeOut)
    {
        this.url = url;
    ...
    protected VJPExtendedSoapSerializationEnvelope createEnvelope()
    {
        VJPExtendedSoapSerializationEnvelope envelope= new VJPExtendedSoapSerializationEnvelope(VJPExtendedSoapSerializationEnvelope.VER12);
        return envelope;
    }
    
    protected java.util.List sendRequest(String methodName,VJPExtendedSoapSerializationEnvelope envelope,org.ksoap2.transport.Transport transport  )throws java.lang.Exception
    {
        return transport.call(methodName, envelope, httpHeaders);
    }

    java.lang.Object getResult(java.lang.Class destObj,java.lang.Object source,String resultName,VJPExtendedSoapSerializationEnvelope __envelope) throws java.lang.Exception
    {
        if(source==null)
        {
            return null;
    ...
    {
        return (Boolean)execute(new VJPIWcfMethod()
        {
            @Override
            public VJPExtendedSoapSerializationEnvelope CreateSoapEnvelope(){
              VJPExtendedSoapSerializationEnvelope __envelope = createEnvelope();
            ...
            @Override
            public java.lang.Object ProcessResult(VJPExtendedSoapSerializationEnvelope __envelope,java.lang.Object __result)throws java.lang.Exception {
    ...
    {
        return (Integer)execute(new VJPIWcfMethod()
        {
            @Override
            public VJPExtendedSoapSerializationEnvelope CreateSoapEnvelope(){
              VJPExtendedSoapSerializationEnvelope __envelope = createEnvelope();
...
/*This feature is available in Premium account, Check http://EasyWsdl.com/Payment/PremiumAccountDetails to see all benefits of Premium account*/
    ...
    protected java.lang.Object execute(VJPIWcfMethod wcfMethod,String methodName) throws java.lang.Exception
    {
        org.ksoap2.transport.Transport __httpTransport=createTransport();
        __httpTransport.debug=enableLogging;
        VJPExtendedSoapSerializationEnvelope __envelope=wcfMethod.CreateSoapEnvelope();
        try
        {
    ...
    java.lang.Exception convertToException(org.ksoap2.SoapFault fault,VJPExtendedSoapSerializationEnvelope envelope)
    {
